...
class SurfApp {
    ...
    private likeVideo(videoIndex: number): void {
        const short = this.shorts[videoIndex];
        const likeIcon = document.querySelector(`[data-video-index="${videoIndex}"].like-btn .icon`) as HTMLElement;
    ...
    private shareVideo(videoIndex: number): void {
